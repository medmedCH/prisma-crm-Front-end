...
export class ProductsIndexFrontContentComponent implements OnInit, AfterViewInit {
  ...
  constructor(private service: CartsService) {
    ...
    this.service.fetchCartsForAClient(StorageService.get('currentUser').userId).subscribe((e) => {
      this.carts = e;
      console.table(e);
      if (this.carts.length === 0) {
        // Creating a new cart :
        this.service.createClientCart(StorageService.get('currentUser').userId).subscribe(( e) => {
          this.carts.push(e);
